...
\myref{https://github.com/The-OpenROAD-Project}{OpenROAD}~\cite{OpenROAD} started as a DARPA-sponsored project to enable an end-to-end design flow of chips from RTL to the final chips without human intervention, within a maximum of 24 hours.

\subsection{OpenLane}

OpenLane~\cite{OpenLANE, openlane:woset:2020} is a collection of EDA tools, such as Yosys, Magic, Netgen, and KLayout. It also includes OpenROAD. OpenLane consists of scripts to automate the flow from RTL, described in Verilog, to the chip production data as a GDSII file.
