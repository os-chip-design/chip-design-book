...
This book is an introduction to chip design using open-source tools. The topic of the book are the steps that are needed to produce a chip for a design described in a hardware description language (HDL) down to the files that are sent to the fab. Those steps are often called the backend design.
...
Very early chips have been designed by hand, and the photo masks have been produced by \emph{drawing} them with tapes. \todo{What was the last chip done this way?} As this process does not scale, the development of computer aided design (CAD) tools have been developed. Another term used is: electroinc design automation (EDA).
